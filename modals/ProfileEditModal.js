...
const ProfileEditModal = ({
  ...
  return (
    <div
      className={`${
        show ? "active" : "invisible"
      } overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-10 w-full md:inset-0 h-full  flex justify-center items-center`}
    >
      <div
        className="relative p-4 w-full md:max-w-xl max-w-md"
              ...
              <div className="h-96 overflow-y-auto ">
                <form className="space-y-2" action="#">
                  ...
                  <div className={`flex flex-col justify-center items-center`}>
                    ...
                    <div className="grid grid-cols-1 gap-4 m-2 w-full">
                      <select
                        // value={skinTypes[0]}
                  ...
                  <div className={` flex flex-col justify-center items-center`}>
                    ...
                    <div className="grid grid-cols-2 gap-4 m-2 overflow-y-auto overflow-x-hidden">
